...
type Props = { height?: number; width?: number; title?: string; titleId?: string | undefined; desc?: string; descId?: string | undefined; };

export const Map = ({ height, width, title, titleId, desc, descId, ...props }: Props) => (
    <svg
    ...
    >
        ...
        <g fill="none" className="borders">
            ...
            <path
                ...
                className="al-ga"
            />
            <path d="m620.9 365.1 1.3 2-1.3 67 4.4 33.2" className="al-ms" />
            <path d="m620.9 365.1 45.7-4" className="al-tn" />
            <path d="m516.7 414.2 52.3-1.3" className="ar-la" />
            <path
            ...
            <path
                ...
                className="ar-ms"
            />
            <path d="m507.9 400.5.7-39-4.1-24.4" className="ar-ok" />
            <path
                ...
                className="ar-tn"
            />
            <path d="m507.9 400.5 2.6 2.3 2.8-1.3 3.2.8.2 11.9" className="ar-tx" />
            <path
                ...
                className="az-ca"
            />
            <path d="m253.8 311-17.4 124.1" className="az-nm" />
            <path
                d="m167.6 296.8-3.4 17.5-2.4 2.9h-2l-1.2-2.7-3.7-1.4-3.5.6-1 13.6.5 4.9-.5 2.9-1.4 3"
                className="az-nv"
            />
            <path d="m167.6 296.8 46.2 8.2 40 6" className="az-ut" />
            <path d="m93.9 166.5-16.4 63.1 1.1 3.5 70.4 105" className="ca-nv" />
            <path d="m27.8 147.9 66.1 18.6" className="ca-or" />
            <path d="m379.4 256.3-4.8 67" className="co-ks" />
            <path d="m347.7 231.8 33.1 2.4-1.4 22.1" className="co-ne" />
            <path d="m253.8 311 52.6 6.5 51.7 4.8" className="co-nm" />
            <path d="m358.1 322.3 16.5 1" className="co-ok" />
            <path d="M265.3 222.7 253.8 311" className="co-ut" />
            <path d="m265.3 222.7 44.9 5.7 37.5 3.4" className="co-wy" />
            <path
            ...
            <path
                ...
                className="ct-ny"
            />
            <path d="m870.7 165.5 3.2 12.3-.4 1.1.4 1.8" className="ct-ri" />
            <path d="m801.8 254.6 1.7-2.6-2.6-1.8-1 1.7" className="dc-md" />
            <path d="m799.9 251.9.5.4.4.1.6.5.3.7-.1.5.2.5" className="dc-va" />
            <path d="m817.9 230.1 7.6 27.1 10.9-2.3" className="de-md" />
            <path d="m823.8 227.2-1 2.2-.3 2.1" className="de-nj" />
            <path d="m817.9 230.1 1.2-2.1 1.5-1.1 1.6-.3 1.6.6" className="de-pa" />
            <path
                d="m687.6 447.4 3.3 6 50.1-3.3.6 3.2 1 1.1 2.1-.6.5-4.3-1.4-2.1v-2.5l2.2-1.4 1.7.9 4 .7 3.6-.3"
                className="fl-ga"
            />
            <path d="m689.5 358.2 21.4-3" className="ga-nc" />
            <path
                ...
                className="ga-sc"
            />
            <path d="m666.6 361.1 22.9-2.9" className="ga-tn" />
            <path
                ...
                className="ia-il"
            />
            <path d="M473.6 182h28.2l36.3-.9 18.6-.7" className="ia-mn" />
            <path
            ...
            <path
                ...
                className="id-mt"
            />
            <path d="m140.9 177.7 24.4 5.4 23.3 4.7" className="id-nv" />
            <path
                ...
                className="id-or"
            />
            <path d="m236.5 196-47.9-8.2" className="id-ut" />
            <path d="m174.6 27.5-12.7 56.1.7 4-1.1 4.3" className="id-wa" />
            <path d="m245 141.2-8.5 54.8" className="id-wy" />
            <path
            ...
            <path
                ...
                className="il-mo"
            />
            <path d="m567.2 202 45.9-2.8" className="il-wi" />
            <path
                ...
                className="in-ky"
            />
            <path d="m630.9 213.2 32.4-3.4.1 1.4" className="in-mi" />
            <path d="m670 268.4-6.6-57.2" className="in-oh" />
            <path
                d="m504.3 326.3-.5-48.1-3.2-.7-2.6-4.7-2.5-2.5.5-2.3 2.7-2.6.1-1.2-1.5-2.1-.9 1-2-.6-2.9-3"
                className="ks-mo"
            />
            <path d="m379.4 256.3 36 2 43.7 1.2h32.4" className="ks-ne" />
            <path d="m374.6 323.3 67.7 2.9 62 .1" className="ks-ok" />
            <path
            ...
            <path
                ...
                className="ma-nh"
            />
            <path d="m843.8 171.3-.7-1 .5-15" className="ma-ny" />
            <path
                d="m870.7 165.5 6.5-2 .7 2.6h.8l.6 2.2 2.6 1.3 1.3 1.1 1.4 3"
                className="ma-ri"
            />
            <path d="m843.6 155.3 12.4-2.7" className="ma-vt" />
            <path d="m757.4 241.9 60.5-11.8" className="md-pa" />
            <path
            ...
            <path
                ...
                className="me-nh"
            />
            <path d="m663.4 211.2 21.4-3.5" className="mi-oh" />
            <path
            ...
            <path
                ...
                className="mn-wi"
            />
            <path d="m491.5 259.5-3.9-6.3-2.1-3.7.3-1.4-1.3-1.3" className="mo-ne" />
            <path d="m504.3 326.3.2 10.8" className="mo-ok" />
            <path
                d="m591.7 344.9 1-2 1.2-.5v-.7l-1.2-1.1-.6-1 1.7.2.8-.7-1.4-1.5 1.4-.5.1-1-.6-1v-1.3m1 0 .8.7.8-1"
                className="mo-tn"
            />
            <path d="m582.6 367.7 38.3-2.6" className="ms-tn" />
            <path d="m362.5 56.3-5.2 66.7" className="mt-nd" />
            <path d="m357.3 123-2 20.7" className="mt-sd" />
            <path d="m355.3 143.7-51-5.3-57.3-7.9-2 10.7" className="mt-wy" />
            <path
            ...
            <path
                ...
                className="nc-tn"
            />
            <path d="m731.1 317 29.4-3.5 39.4-7.3 29.1-6.1" className="nc-va" />
            <path d="m357.3 123 39.2 2.9 46 2.1 29.5.4" className="nd-sd" />
            <path
                ...
                className="ne-sd"
            />
            <path d="m347.7 231.8 3.7-44.2" className="ne-wy" />
            <path
                ...
                className="nh-vt"
            />
            <path d="m827.9 190.5 14.6 4.9-.4 5.9" className="nj-ny" />
            <path
                d="m823.8 227.2 1.4-1.7 1.6-.6 1.8-3 1.6-2.3 3.3-2.6-4.2-3.2-2.1-1.1-1-2.8-2.7-.9-.5-3.6 1-1 .7-2-1.5-1.8 3-5.4-.1-2.2 1.8-2.5"
                className="nj-pa"
            />
            <path d="m358.1 322.3-.6 10.6" className="nm-ok" />
            <path
                d="m284.3 431.2-2-2.2.3-3 34.4 3.6 31.8 2.6 7.9-99.3h.8"
                className="nm-tx"
            />
            <path d="m93.9 166.5 47 11.2" className="nv-or" />
            <path d="m188.6 187.8-21 109" className="nv-ut" />
            <path
            ...
            <path
                ...
                className="ny-vt"
            />
            <path d="m736.8 225.1-4.9-29.9" className="oh-pa" />
            <path
            ...
            <path
                ...
                className="or-wa"
            />
            <path d="m736.8 225.1 3.2 19.7 17.4-2.9" className="pa-wv" />
            <path d="m351.4 187.6 3.9-43.9" className="sd-wy" />
            <path d="m697.7 321.1 28.9-3.3.2-1 4.6-.5-.3.7" className="tn-va" />
            <path d="m236.5 196-3.3 21.9 32.1 4.8" className="ut-wy" />
            <path
