...
export const stateCoordinates: StateCoordinate[] = [
  ...
  {
    coordinates:
      "m374.6 323.3-16.5-1-51.7-4.8-52.6-6.5 11.5-88.3 44.9 5.7 37.5 3.4 33.1 2.4-1.4 22.1z",
    code: "co",
    name: "Colorado",
  },
  {
  ...
  {
    coordinates:
      "m233.2 217.9 3.3-21.9-47.9-8.2-21 109 46.2 8.2 40 6 11.5-88.3z",
    code: "ut",
    name: "Utah",
  },
  {
  ...
  {
    coordinates:
      "m355.3 143.7-51-5.3-57.3-7.9-2 10.7-8.5 54.8-3.3 21.9 32.1 4.8 44.9 5.7 37.5 3.4 3.7-44.2z",
    code: "wy",
    name: "Wyoming",
  },
  {
    coordinates: "m803.5 252-2.6-1.8-1 1.7.5.4.4.1.6.5.3.7-.1.5.2.5z",
    code: "dc",
    name: "District of Columbia",
  },
];

// [...wikipediaMap.matchAll(/<path\s+d="([^"]+)"\s+className="([^"]+)"[^>]*>/gm)].map(border => ({ coordinates: border[1], stateA: border[2].split('-')[0], stateB: border[2].split('-')[1] }))
export const borderCoordinates: BorderCordinate[] = [
  {
    coordinates:
      "m687.6 447.4-48.8 5.1-.5 2.9 2.5 2.8 1.7.7.9 1.2-.4 7.3-1.1.6",
    stateA: "al",
    stateB: "fl",
  },
  {
    coordinates:
      "m666.6 361.1 12.9 45.8 2.9 6.1 1.8 1.9v3.2l1.7 1 .2 1.1-2.2 3.8-.3 3.7-.5 2.6 2.4 5.7-.6 6.3.5 1.4 1.5 1.5.7 2.2",
    stateA: "al",
    stateB: "ga",
  },
  {
    coordinates: "m620.9 365.1 1.3 2-1.3 67 4.4 33.2",
    stateA: "al",
    stateB: "ms",
  },
  {
    coordinates: "m620.9 365.1 45.7-4",
    stateA: "al",
    stateB: "tn",
  },
  {
    coordinates: "m516.7 414.2 52.3-1.3",
    stateA: "ar",
    stateB: "la",
  },
  {
    coordinates:
      "m591.7 344.9-11.2.8 2.8-5.1 1.7-1.5v-2.2l-1.6-2.5-39.8 2-39.1.7",
    stateA: "ar",
    stateB: "mo",
  },
  {
    coordinates:
      "m569 412.9 1.2-1.5.5-3-1.5-2.3-.5-2.2.9-.7v-.8l-1.7-1.1-.1-.7 1.6-.9-1.2-1.1 1.7-7.1 3.4-1.6v-.8l-1.1-1.4 2.9-5.4h1.9l1.5-1.2-.3-5.2 3.1-4.5 1.8-.6-.5-3.1",
    stateA: "ar",
    stateB: "ms",
  },
  {
    coordinates: "m507.9 400.5.7-39-4.1-24.4",
    stateA: "ar",
    stateB: "ok",
  },
  {
    coordinates:
      "m582.6 367.7 1.6-.7.9-2.2 1.2.5.7-1-.8-.7.3-1.5-1.1-.9.6-1-.1-1.5-1.1-.1.8-.8 1.3.8.3-1.4-.4-1.1.1-.7 2 .6-.4-1.5 1.6-1.3-.5-.9-1.1.1-.6-.9.9-.9 1.6-.2.5-.8 1.4-.2-.1-.8-.9-.9v-.5h1.5l.4-.7-1.4-1-.1-.6",
    stateA: "ar",
    stateB: "tn",
  },
  {
    coordinates: "m507.9 400.5 2.6 2.3 2.8-1.3 3.2.8.2 11.9",
    stateA: "ar",
    stateB: "tx",
  },
  {
    coordinates:
      "m149 338.1-.9 2.1 1.3 3.4 1.4 1.8 1.2 5.8 2.3 2.5.4 1.9-1.3 1.3-4.8 1.7-2.4 3.6-1.6 7-2.4 3.2-1.6.3-1.1 6.9 1.1 1.6 1.8.2 1 1.6-.8 2.4-3 2.2-2.2-.1",
    stateA: "az",
    stateB: "ca",
  },
  {
    coordinates: "m253.8 311-17.4 124.1",
    stateA: "az",
    stateB: "nm",
  },
  {
    coordinates:
      "m167.6 296.8-3.4 17.5-2.4 2.9h-2l-1.2-2.7-3.7-1.4-3.5.6-1 13.6.5 4.9-.5 2.9-1.4 3",
    stateA: "az",
    stateB: "nv",
  },
  {
    coordinates: "m167.6 296.8 46.2 8.2 40 6",
    stateA: "az",
    stateB: "ut",
  },
  {
    coordinates: "m93.9 166.5-16.4 63.1 1.1 3.5 70.4 105",
    stateA: "ca",
    stateB: "nv",
  },
  {
    coordinates: "m27.8 147.9 66.1 18.6",
    stateA: "ca",
    stateB: "or",
  },
  {
    coordinates: "m379.4 256.3-4.8 67",
    stateA: "co",
    stateB: "ks",
  },
  {
    coordinates: "m347.7 231.8 33.1 2.4-1.4 22.1",
    stateA: "co",
    stateB: "ne",
  },
  {
    coordinates: "m253.8 311 52.6 6.5 51.7 4.8",
    stateA: "co",
    stateB: "nm",
  },
  {
    coordinates: "m358.1 322.3 16.5 1",
    stateA: "co",
    stateB: "ok",
  },
  {
    coordinates: "M265.3 222.7 253.8 311",
    stateA: "co",
    stateB: "ut",
  },
  {
    coordinates: "m265.3 222.7 44.9 5.7 37.5 3.4",
    stateA: "co",
    stateB: "wy",
  },
  {
    coordinates: "m843.8 171.3 10.5-2.4.5.7.9-.3v-.7l14.9-3.4.1.3",
    stateA: "ct",
    stateB: "ma",
  },
  {
    coordinates: "m846.6 194.7-1.7-2.2 3.5-3.4-1.8-1.5-2.8-16.3",
    stateA: "ct",
    stateB: "ny",
  },
  {
    coordinates: "m870.7 165.5 3.2 12.3-.4 1.1.4 1.8",
    stateA: "ct",
    stateB: "ri",
  },
  {
    coordinates: "m801.8 254.6 1.7-2.6-2.6-1.8-1 1.7",
    stateA: "dc",
    stateB: "md",
  },
  {
    coordinates: "m799.9 251.9.5.4.4.1.6.5.3.7-.1.5.2.5",
    stateA: "dc",
    stateB: "va",
  },
  {
    coordinates: "m817.9 230.1 7.6 27.1 10.9-2.3",
    stateA: "de",
    stateB: "md",
  },
  {
    coordinates: "m823.8 227.2-1 2.2-.3 2.1",
    stateA: "de",
    stateB: "nj",
  },
  {
    coordinates: "m817.9 230.1 1.2-2.1 1.5-1.1 1.6-.3 1.6.6",
    stateA: "de",
    stateB: "pa",
  },
  {
    coordinates:
      "m687.6 447.4 3.3 6 50.1-3.3.6 3.2 1 1.1 2.1-.6.5-4.3-1.4-2.1v-2.5l2.2-1.4 1.7.9 4 .7 3.6-.3",
    stateA: "fl",
    stateB: "ga",
  },
  {
    coordinates: "m689.5 358.2 21.4-3",
    stateA: "ga",
    stateB: "nc",
  },
  {
    coordinates:
      "m710.9 355.2-.1 1.9-1.9 1-1.4 3.2.2 1.3 6.1 3.8 2.6-.3 3.1 4 .4 1.7 4.2 5.1 2.6 1.7 1.4.2 2.2 1.6 1.1 2.2 2 1.6 1.8.5 2.7 2.7.1 1.4 2.6 2.8 5 2.3 3.6 6.7.3 2.7 3.9 2.1 2.5 4.8.8 3.1 4.2.4",
    stateA: "ga",
    stateB: "sc",
  },
  {
    coordinates: "m666.6 361.1 22.9-2.9",
    stateA: "ga",
    stateB: "tn",
  },
  {
    coordinates:
      "m556.8 249.7.7-.7.1-2.3-.7-.9 1-1.5 1.8-.6.9-.3 1-1.2v-2.4l1.7-2.4.5-.5.1-3.5-.9-1.4-1-.3-1.1-1.6 1-4 3-.8h2.4l4.2-1.8 1.7-2.2.1-2.4 1.1-1.3 1.3-3.2-.1-2.6-2.8-3.5h-1.2l-.9-1.1.2-1.6-1.7-1.7-2.5-1.3.5-.6",
    stateA: "ia",
    stateB: "il",
  },
  {
    coordinates: "M473.6 182h28.2l36.3-.9 18.6-.7",
    stateA: "ia",
    stateB: "mn",
  },
  {
    coordinates:
      "m484.5 246.8 25.9.1 27.2-1.2 14.3-.8 1.7 1.3.6 1.6 1.1 1.1 1.5.8",
    stateA: "ia",
    stateB: "mo",
  },
  {
    coordinates:
      "m484.5 246.8-1.8-4.4.7-2.2-.8-3.3.2-2.9-1.3-.7-.4-6.1-2.8-5-.2-3.7-2.2-4.3-1.3-3.7v-1.4l-.6-1.7v-2.3l-.5-.9",
    stateA: "ia",
    stateB: "ne",
  },
  {
    coordinates:
      "m473.5 204.2-.7-1.7-.3-1.3-1.3-1.2 1-4.3 1.7-5.1-.7-2-1.3-.4-.4-1.6 1-.5.1-1.1-1.3-1.5.1-1.6 2.2.1",
    stateA: "ia",
    stateB: "sd",
  },
  {
    coordinates:
      "m567.2 202-1.3-2.8-3.3-.7-2.7-1.5-2-5.5.1-2.5 1.6-3.3-.6-1.1-2.1-1.6-.2-2.6",
    stateA: "ia",
    stateB: "wi",
  },
  {
    coordinates:
      "m188.8 30.5-4.8 22 3.7 7.4-1.6 4.8 3.6 4.8 1.9.7 3.9 8.3v2.1l2.3 3h.9l1.4 2.1h3.2v1.6l-7.1 17-.5 4.1 1.4.5 1.6 2.6 2.8-1.4 3.6-2.4 1.9 1.9.5 2.5-.5 3.2 2.5 9.7 2.6 3.5 2.3 1.4.4 3v4.1l2.3 2.3 1.6-2.3 6.9 1.6 2.1-1.2 9 1.7 2.8-3.3 1.8-.6 1.2 1.8 1.6 4.1.9.1",
    stateA: "id",
    stateB: "mt",
  },
  {
    coordinates: "m140.9 177.7 24.4 5.4 23.3 4.7",
    stateA: "id",
    stateB: "nv",
  },
  {
    coordinates:
      "m140.9 177.7 8.5-37.3 2.9-5.8.4-2.1.8-.9-.9-2-2.9-1.2.2-4.2 4-5.8 2.5-.8 1.6-2.3-.1-1.6 1.8-1.6 3.2-5.5 4.2-4.8-.5-3.2-3.5-3.1-1.6-3.6",
    stateA: "id",
    stateB: "or",
  },
  {
    coordinates: "m236.5 196-47.9-8.2",
    stateA: "id",
    stateB: "ut",
  },
  {
    coordinates: "m174.6 27.5-12.7 56.1.7 4-1.1 4.3",
    stateA: "id",
    stateB: "wa",
  },
  {
    coordinates: "m245 141.2-8.5 54.8",
    stateA: "id",
    stateB: "wy",
  },
  {
    coordinates:
      "m619.4 215.7 4.1 50.2-1 5.2v2l2.4 3.5v.7l-.3.9.9 1.9-.3 2.4-1.6 1.8-1.3 4.2-3.8 5.3-.1 7h-1l.9 1.9",
    stateA: "il",
    stateB: "in",
  },
  {
    coordinates:
      "m599.9 322.5-.3-1.8 4-3.7 6.9 3 1.5-.3.4-2.4-1.7-1.8.4-3.3 1-.5 1.2.6.6-1.2 3.7-.6.1-.9-1.5-2.2-.1-1.1 2.2-2.7v-.9",
    stateA: "il",
    stateB: "ky",
  },
  {
    coordinates:
      "M599.9 322.5h-2.8l-1.4-1.5-1.8-3.8v-1.9l.8-.6.1-1.3-1.7-1.9-.9-2.5-2.7-4.1-4.8-1.3-7.4-7.1-.4-2.4 2.8-7.6-.4-1.9 1.2-1.1v-1.3l-2.8-1.5-3-.7-3.4 1.2-1.3-2.3.6-1.9-.7-2.4-8.6-8.4-2.2-1.5-2.5-5.9-1.2-5.4 1.4-3.7",
    stateA: "il",
    stateB: "mo",
  },
  {
    coordinates: "m567.2 202 45.9-2.8",
    stateA: "il",
    stateB: "wi",
  },
  {
    coordinates:
      "m618.3 302.7 1.1.8.6-1-.7-1.7 4.6-.5.2 1.2 1.1.2.4-.9-.6-1.3.3-.8 1.3.8 1.7-.4 1.7.6 3.4 2.1 1.8-2.8 3.5-2.2 3 3.3 1.6-2.1.3-2.7 3.8-2.3.2 1.3 1.9 1.2 3-.2 1.2-.7.1-3.4 2.5-3.7 4.6-4.4-.1-1.7 1.2-3.8 2.2 1 6.7-4.5-.4-1.7-1.5-2.1 1-1.9",
    stateA: "in",
    stateB: "ky",
  },
  {
    coordinates: "m630.9 213.2 32.4-3.4.1 1.4",
    stateA: "in",
    stateB: "mi",
  },
  {
    coordinates: "m670 268.4-6.6-57.2",
    stateA: "in",
    stateB: "oh",
  },
  {
    coordinates:
      "m504.3 326.3-.5-48.1-3.2-.7-2.6-4.7-2.5-2.5.5-2.3 2.7-2.6.1-1.2-1.5-2.1-.9 1-2-.6-2.9-3",
    stateA: "ks",
    stateB: "mo",
  },
  {
    coordinates: "m379.4 256.3 36 2 43.7 1.2h32.4",
    stateA: "ks",
    stateB: "ne",
  },
  {
    coordinates: "m374.6 323.3 67.7 2.9 62 .1",
    stateA: "ks",
    stateB: "ok",
  },
  {
    coordinates:
      "m596.7 333.5 1-2.7 1.4.9.7-.4 1.2-4.1-1-1 1-2 .2-.9-1.3-.8m-5.8 11.3-.7-.7.2-1h1.1l.7.7-.3 1",
    stateA: "ky",
    stateB: "mo",
  },
  {
    coordinates:
      "m670 268.4 1.3.5 2.2.1 1.9-.8 2.9 1.2 2.2 3.4v1l4.1.7 2.3-.2 1.9 2.1 2.2.2v-1l1.9-.8 3 .8 1.2.8 1.3-.7h.9l.6-1.7 3.4-1.8.5.8.8 2.9 3.5 1.4 1.2 2.1",
    stateA: "ky",
    stateB: "oh",
  },
  {
    coordinates:
      "M596.7 333.5 620 332l.6-.9-1.2-3.2h3.7l.7.6 22.6-2 2.6-.8 17.4-1 5.2-.8 20.5-1.4 5.6-1.4m-103.6 12.7h1",
    stateA: "ky",
    stateB: "tn",
  },
  {
    coordinates:
      "m697.7 321.1 6.9-4.2 1-.4.5-1.9 1.8-.5 1.4-1.4.1-1.7 2.1-1.3.4-2.2 3-3 2.9-1 4.9-6.6",
    stateA: "ky",
    stateB: "va",
  },
  {
    coordinates:
      "m709.3 279.4-.1 1.1.6 1-.6 3.6 1.9 1.6.8 1.1 1 .6-.1.9 4.4 5.6h1.4l1.5 1.8 1.2.3 1.4-.1",
    stateA: "ky",
    stateB: "wv",
  },
  {
    coordinates:
      "m569 412.9-.6 1.4 1.6 7.1 1.2 1-.5 1.7 2.4 2.5v3.3h-2l1.8 2.5-6 8.4-2.4 4.8-1.7 11.9 36-2-.1 1.4-1 1.4-.9 4.6 4.8 6.8-.3 1.3 1.2 1.8.6.7",
    stateA: "la",
    stateB: "ms",
  },
  {
    coordinates:
      "m516.7 414.2.5 19.9.7 3.4 2.6 2.8.7 5.4 3.8 4.6.8 4.3h1l-.1 7.3-3.3 6.4 1.3 2.3-1.3 1.5.7 3-.1 4.3-2.2 3.5-.1.8-1.7 1.2 1 1.8 1.2 1.1",
    stateA: "la",
    stateB: "tx",
  },
  {
    coordinates: "m856 152.6 18.4-3.8 1-1.5.3-1.7 1.9-.6.5-1.1 1.7-1.1 1.3.3",
    stateA: "ma",
    stateB: "nh",
  },
  {
    coordinates: "m843.8 171.3-.7-1 .5-15",
    stateA: "ma",
    stateB: "ny",
  },
  {
    coordinates: "m870.7 165.5 6.5-2 .7 2.6h.8l.6 2.2 2.6 1.3 1.3 1.1 1.4 3",
    stateA: "ma",
    stateB: "ri",
  },
  {
    coordinates: "m843.6 155.3 12.4-2.7",
    stateA: "ma",
    stateB: "vt",
  },
  {
    coordinates: "m757.4 241.9 60.5-11.8",
    stateA: "md",
    stateB: "pa",
  },
  {
    coordinates:
      "m822.9 269.3-.8.1m13.2-4.3-.6.3m-1.3.2-4.6 1.6-.7.8m-28.2-16.1-.6-.6h-1l-.6-.1-.4-.4.1-.5-1.7-.6-.8.3-1.2-.1-.7-.7-.5-.2-.2-.7.6-.8v-.9l-1.2-.2-1-.9-.9.1-1.6-.3m11.6 13.5.3-.4-.7-1 1-.1 1-.9.4-1.8",
    stateA: "md",
    stateB: "va",
  },
  {
    coordinates:
      "m757.4 241.9 1.7 11.4 1.8-1.6.9-1.6 3.1-3.9 2.2.3 2.6-3.8 1.9 1 3.3-.4 1.7-2.9h1.3l.9-1.4 1.4-.3 2.2 1.6 2.6-.4-.2 1 .8 1.2h.7l.2.7 1 .5-.2 1.6.9.4",
    stateA: "md",
    stateB: "wv",
  },
  {
    coordinates: "m881.9 138.3-2.3-1.4-.8-2.2-3.2-2-.6-4-11.9-36.8",
    stateA: "me",
    stateB: "nh",
  },
  {
    coordinates: "m663.4 211.2 21.4-3.5",
    stateA: "mi",
    stateB: "oh",
  },
  {
    coordinates:
      "m565.6 112.3 1.9.7 3 3.8 17 3.8 1.4 1 4 .8.7.5 2.8-.2 4.9.8 1.4 1.5-1 1 .8.8 3.8.7 1.2 1.2.1 4.4-1.3 2.8 2 .1 1-.8.9.8-1.1 3.1 1 1.6 1.2.3",
    stateA: "mi",
    stateB: "wi",
  },
  {
    coordinates:
      "m462.3 61.3 2.4 7.3-1.1 2.8.8 1.4-.3 5.1-.5 1.1 2.7 9.1 1.3 2.5.7 14 1 2.7-.4 5.8 2.9 7.4.3 5.8-.1 2.1",
    stateA: "mn",
    stateB: "nd",
  },
  {
    coordinates:
      "m473.6 182 .2-39.5-1.5-1.9-2.6-.6-.4-1.8-1.7-2.5.3-1.2 3.1-1.9.9-2 .1-2.2",
    stateA: "mn",
    stateB: "sd",
  },
  {
    coordinates:
      "m556.7 180.4-1.1-4.5-.2-3-2.2-3-2.8-.7-5.2-3.6-.6-3.3-6.3-3.1-.2-1.3h-3.3l-2.2-2.6-2-1.3.7-5.1-.9-1.6.5-5.4 1-1.8-.3-2.7-1.2-1.3-1.8-.3v-1.7l2.8-5.8 5.9-3.9-.4-13 .9.4.6-.5.1-1.1.9-.6 1.4 1.2.7-.1",
    stateA: "mn",
    stateB: "wi",
  },
  {
    coordinates: "m491.5 259.5-3.9-6.3-2.1-3.7.3-1.4-1.3-1.3",
    stateA: "mo",
    stateB: "ne",
  },
  {
    coordinates: "m504.3 326.3.2 10.8",
    stateA: "mo",
    stateB: "ok",
  },
  {
    coordinates:
      "m591.7 344.9 1-2 1.2-.5v-.7l-1.2-1.1-.6-1 1.7.2.8-.7-1.4-1.5 1.4-.5.1-1-.6-1v-1.3m1 0 .8.7.8-1",
    stateA: "mo",
    stateB: "tn",
  },
  {
    coordinates: "m582.6 367.7 38.3-2.6",
    stateA: "ms",
    stateB: "tn",
  },
  {
    coordinates: "m362.5 56.3-5.2 66.7",
    stateA: "mt",
    stateB: "nd",
  },
  {
    coordinates: "m357.3 123-2 20.7",
    stateA: "mt",
    stateB: "sd",
  },
  {
    coordinates: "m355.3 143.7-51-5.3-57.3-7.9-2 10.7",
    stateA: "mt",
    stateB: "wy",
  },
  {
    coordinates:
      "m710.9 355.2 4.4-1.9 1.3-.1 7.3-4.3 23.2-2.2.4.5-.2 1.4.7.3 1.2-1.5 3.3 3 .1 2.6 19.7-2.8 24.5 17.1",
    stateA: "nc",
    stateB: "sc",
  },
  {
    coordinates:
      "M731.1 317v5.2l-1.5-.1-1.4 1.2-2.4 5.2-2.6-1.1-3.5 2.5-.7 2.1-1.5 1.2-.8-.8-.1-1.5-.8-.2-4 3.3-.6 3.4-4.7 2.4-.5 1.2-3.2 2.6-3.6.5-4.6 3-.8 4.1-1.3.9-1.5-.1-1.4 1.3-.1 4.9",
    stateA: "nc",
    stateB: "tn",
  },
  {
    coordinates: "m731.1 317 29.4-3.5 39.4-7.3 29.1-6.1",
    stateA: "nc",
    stateB: "va",
  },
  {
    coordinates: "m357.3 123 39.2 2.9 46 2.1 29.5.4",
    stateA: "nd",
    stateB: "sd",
  },
  {
    coordinates:
      "m351.4 187.6 51.1 3.5 38 1.6 3.4 3.2 1.7.2 2.1 2 1.8-.1 1.8-2 1.5.6 1-.7.7.5.9-.4.7.4.9-.4 1 .5 1.4-.6 2 .6.6 1.1 6.1 2.2 1.2 1.3.9 2.6 1.8.7 1.5-.2",
    stateA: "ne",
    stateB: "sd",
  },
  {
    coordinates: "m347.7 231.8 3.7-44.2",
    stateA: "ne",
    stateB: "wy",
  },
  {
    coordinates:
      "m857.9 100.1 1.2 2.3-1.1 3.5 2.1 2.8-.4 1.7.1 1.3-1.1 2.1-1.4.4-.6 1.3-2.1 1-.7 1.5 1.4 3.4-.5 2.5.5 1.5-1 1.9.4 1.9-1.3 1.9.2 2.2-.7 1.1.7 4.5.7 1.5-.5 2.6.9 1.8-.2 2.5-.5 1.3-.1 1.4 2.1 2.6",
    stateA: "nh",
    stateB: "vt",
  },
  {
    coordinates: "m827.9 190.5 14.6 4.9-.4 5.9",
    stateA: "nj",
    stateB: "ny",
  },
  {
    coordinates:
      "m823.8 227.2 1.4-1.7 1.6-.6 1.8-3 1.6-2.3 3.3-2.6-4.2-3.2-2.1-1.1-1-2.8-2.7-.9-.5-3.6 1-1 .7-2-1.5-1.8 3-5.4-.1-2.2 1.8-2.5",
    stateA: "nj",
    stateB: "pa",
  },
  {
    coordinates: "m358.1 322.3-.6 10.6",
    stateA: "nm",
    stateB: "ok",
  },
  {
    coordinates: "m284.3 431.2-2-2.2.3-3 34.4 3.6 31.8 2.6 7.9-99.3h.8",
    stateA: "nm",
    stateB: "tx",
  },
  {
    coordinates: "m93.9 166.5 47 11.2",
    stateA: "nv",
    stateB: "or",
  },
  {
    coordinates: "m188.6 187.8-21 109",
    stateA: "nv",
    stateB: "ut",
  },
  {
    coordinates:
      "m827.9 190.5-1.6-1.1-1.9.3-3-2.2-3-5.8h-2l-.4-1.5-1.7-1.1-70.5 13.9-.8-6",
    stateA: "ny",
    stateB: "pa",
  },
  {
    coordinates:
      "m843.6 155.3-1.1-1 .5-2-3-14.2-1.9-1.5-.9 1.6-.9-2.2.8-1.8-3.1-6.7.3-3.8.4-1-.6-2 .4-2.2-2.2-2.3-.5-3.2.4-1.5-1.4-.9.6-1.9-.8-1.7",
    stateA: "ny",
    stateB: "vt",
  },
  {
    coordinates: "m736.8 225.1-4.9-29.9",
    stateA: "oh",
    stateB: "pa",
  },
  {
    coordinates:
      "m709.3 279.4 3.2-1.4h1.5l.4-3.5 1.5-.8-1.3-3.6 1.1-1.3.3-2.2 1-2.3 1.6.5.6 2.1 1-.5.7-.8 1-.2v-1.9l-1.4-1.1 1-.5-.1-2.1 1.3-2.2h1.3l.3-1.2 1.5-1.8 1.3 1.2 1.8-1.7h.6l1.8-2 2-3.3 1.1-.5.4-2.2-.5-1.1 1-3.6.1-5.4 1.1-3.4-.6-2 .1-2.2-1.4-2.1 2.2-1.2",
    stateA: "oh",
    stateB: "wv",
  },
  {
    coordinates:
      "m357.5 332.9 52.6 3.2-1.4 42.7 2.7 1.3 2.5 3 1.5.3 1.1-1 1.2.4 1.4 1 1.1-1.5 2.3 1.7.5 2.9 1.2.7 2.3-.1 3.5 1.9 2-.1 1.4-.4 2.3 2.2 2-2.3 3.5 1.1 1.9 3 2.3-.1-.7 2.1 2.3 1.1 3-2.6 2.6 1.7 1.3-.5.1 1.5 1.7 1.2 2.3-2.5 1.2.7-.3 2 1 1.8 1.2-.8 2.5-4.2 1.8 2 2 .5 2.1-.7 2 1.8 1.2-.1 1.3 1.2 3.6-.9.6-1.7 3.7-.3 1.6.7 5-2.5.6 1.5 5.1-.3.5-1.6 2.2.9 4.6 3.8 6.4 1.9",
    stateA: "ok",
    stateB: "tx",
  },
  {
    coordinates:
      "m161.5 91.9-30.3-7.3-2.8 1-5.4-.9-1.8-.9-1.5 1.2-3.3-.4-4.5.5-.9.7-4.2-.4-.8-1.6-1.2-.2-4.4 1.3-1.6-1.1-2.2.8-.2-1.8-2.3-1.2-1.5-.2-1-1.1-3 .3-1.2-.8h-1.2l-1.2.9-5.5.7-6.6-4.2 1.1-5.6-.4-4.1-3.2-3.7-3.7.1-.4-1.1.4-1.2-.7-.8-1 .1",
    stateA: "or",
    stateB: "wa",
  },
  {
    coordinates: "m736.8 225.1 3.2 19.7 17.4-2.9",
    stateA: "pa",
    stateB: "wv",
  },
  {
    coordinates: "m351.4 187.6 3.9-43.9",
    stateA: "sd",
    stateB: "wy",
  },
  {
    coordinates: "m697.7 321.1 28.9-3.3.2-1 4.6-.5-.3.7",
    stateA: "tn",
    stateB: "va",
  },
  {
    coordinates: "m236.5 196-3.3 21.9 32.1 4.8",
    stateA: "ut",
    stateB: "wy",
  },
  {
